 ...
 *@创建时间  2021/5/21
 */
public interface MetadataConstraintService extends IService<MetadataConstraint> {

    List<MetadataConstraint> list(MetadataConstraintParam metadataConstraintParam);

    void addConstraint(List<MetadataConstraint> metadataConstraints);
