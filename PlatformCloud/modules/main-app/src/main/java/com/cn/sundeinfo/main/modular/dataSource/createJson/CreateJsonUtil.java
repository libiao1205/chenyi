package com.cn.sundeinfo.main.modular.dataSource.createJson;
...
public class CreateJsonUtil {
     ...
     * 生成.json格式文件
     */
    public boolean createJsonFile(String collectCode,String jsonString, String fileName) {
        // 标记文件生成是否成功
        boolean flag = true;

        // 拼接文件完整路径
        String fullPath = fileSaveAddressTemp + "/" + collectCode + "/" + File.separator + fileName + ".json";
    ...
    public void downFolder(String collectCode, HttpServletResponse response) {
        //需要压缩的目录
        String filePath = fileSaveAddressTemp + "/" + collectCode;
