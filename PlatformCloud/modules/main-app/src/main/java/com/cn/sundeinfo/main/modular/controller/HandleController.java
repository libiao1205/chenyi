...
import com.cn.sundeinfo.main.modular.restapi.CloudSampleRestApiClient;
...
public class HandleController {
    ...
    @Value("${sundeinfo.main.config.test}")
    ...
    @RequestMapping("/test")
    @ResponseBody
    public String configTest(String id) throws IOException {
//        return Handle.regist(id);
        return "";
    }
