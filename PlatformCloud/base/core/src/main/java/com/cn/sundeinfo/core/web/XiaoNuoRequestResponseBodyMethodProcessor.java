package com.cn.sundeinfo.core.web;

import com.cn.sundeinfo.core.context.param.RequestParamContext;
...
public class XiaoNuoRequestResponseBodyMethodProcessor extends RequestResponseBodyMethodProcessor {
    ...
    public XiaoNuoRequestResponseBodyMethodProcessor(List<HttpMessageConverter<?>> converters) {
        super(converters);
    }
