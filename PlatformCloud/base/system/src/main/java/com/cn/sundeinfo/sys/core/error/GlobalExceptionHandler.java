 ...
 */
package com.cn.sundeinfo.sys.core.error;

import cn.hutool.core.util.ObjectUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.extra.servlet.ServletUtil;
import cn.hutool.log.Log;
import com.cn.sundeinfo.core.consts.AopSortConstant;
...
import com.cn.sundeinfo.core.exception.enums.*;
...
import com.cn.sundeinfo.core.sms.modular.aliyun.exp.AliyunSmsException;
import com.cn.sundeinfo.core.sms.modular.tencent.exp.TencentSmsException;
import com.cn.sundeinfo.core.util.ResponseUtil;
...
public class GlobalExceptionHandler {
    ...
    private ErrorResponseData renderJson(Integer code, String message, Throwable e) {
        if (ObjectUtil.isNotNull(e)) {
            ...
            //遍历所有堆栈信息，找到com.cn.sundeinfo开头的第一条异常信息
