 ...
 */
package com.cn.sundeinfo.sys.modular.dict.controller;
...
public class SysDictDataController {
     ...
     */
    @Permission
    @GetMapping("/sysDictData/search")
    @BusinessLog(title = "系统字典值_查询", opType = LogAnnotionOpTypeEnum.QUERY)
    public ResponseData searchPage(SysDictDataParam sysDictDataParam) {
        return new SuccessResponseData(sysDictDataService.searchPage(sysDictDataParam));
    }
     ...
     */
    @Permission
    @GetMapping("/sysDictData/children/list")
    @BusinessLog(title = "系统字典值_列表", opType = LogAnnotionOpTypeEnum.QUERY)
    public ResponseData findChildrenById(@Validated(SysDictDataParam.list.class) SysDictDataParam sysDictDataParam) {
        return new SuccessResponseData(sysDictDataService.childrenList(sysDictDataParam));
    }
     ...
     */
    @Permission
    @GetMapping("/sysDictData/treeByCode")
    @BusinessLog(title = "系统字典值_树状", opType = LogAnnotionOpTypeEnum.QUERY)
    public ResponseData treeByCode(@Validated(SysDictDataParam.list.class) @RequestParam("id") Long id) {
        return new SuccessResponseData(sysDictDataService.treeByCode(id));
    }
     ...
     */
    @Permission
    @GetMapping("/sysDictData/listByParentIdIsNull")
    @BusinessLog(title = "系统字典值_列表", opType = LogAnnotionOpTypeEnum.QUERY)
    public ResponseData listByParentIdIsNull(@Validated(SysDictDataParam.list.class) @RequestParam("typeCode") String typeCode) {
        return new SuccessResponseData(sysDictDataService.findByParentIdIsNullList(typeCode));
    }
