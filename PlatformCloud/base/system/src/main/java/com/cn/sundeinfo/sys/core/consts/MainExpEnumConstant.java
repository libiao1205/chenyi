 ...
 */
package com.cn.sundeinfo.sys.core.consts;
...
public interface MainExpEnumConstant {
     ...
     */
    int SUNDEINFO_MAIN_MODULE_EXP_CODE = 30;

    /**
     * 数据采集相关异常枚举
     */
    int DATA_GATHER_EXCEPTION_ENUM = 1100;

    /**
     * 元数据相关异常枚举
     */
    int METADATA_EXCEPTION_ENUM = 1200;

    /**
     * 数据源相关异常枚举
     */
    int DATA_SOURCE_EXCEPTION_ENUM = 1300;

    /**
     * 数据集相关异常枚举
     */
    int DATA_COLLECT_EXCEPTION_ENUM = 1400;
}
