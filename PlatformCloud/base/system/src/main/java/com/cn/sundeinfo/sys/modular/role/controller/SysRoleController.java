 ...
 */
package com.cn.sundeinfo.sys.modular.role.controller;

import com.cn.sundeinfo.core.annotion.BusinessLog;
import com.cn.sundeinfo.core.annotion.DataScope;
...
public class SysRoleController {
    ...
    @Permission
    @DataScope
    @PostMapping("/sysRole/grantMetadataColumn")
    @BusinessLog(title = "系统角色_授权资源", opType = LogAnnotionOpTypeEnum.GRANT)
    public ResponseData grantMetadataColumn(@RequestBody @Validated(SysRoleParam.grantMetadata.class) SysRoleParam sysRoleParam) {
        sysRoleMetadataService.grantMetadataColumn(sysRoleParam);
        return new SuccessResponseData();
    }
