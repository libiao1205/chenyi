 ...
 */
package com.cn.sundeinfo.sys.modular.oauth.enums;
 ...
 */
@ExpEnumType(module = SysExpEnumConstant.XIAONUO_SYS_MODULE_EXP_CODE, kind = SysExpEnumConstant.OAUTH_EXCEPTION_ENUM)
