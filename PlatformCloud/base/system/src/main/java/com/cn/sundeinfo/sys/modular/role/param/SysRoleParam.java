 ...
 */
package com.cn.sundeinfo.sys.modular.role.param;
...
public class SysRoleParam extends BaseParam {
     ...
     * 授权数据
     */
    @NotNull(message = "授权数据不能为空，请检查grantOrgIdList参数", groups = {grantMetadata.class})
    private List<SysRoleMetadataParam> grantMetadataPermissionList;
