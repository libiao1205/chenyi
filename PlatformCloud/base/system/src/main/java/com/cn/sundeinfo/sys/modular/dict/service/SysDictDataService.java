 ...
 */
package com.cn.sundeinfo.sys.modular.dict.service;
...
public interface SysDictDataService extends IService<SysDictData> {
     ...
     *@创建时间  2021/4/16
     */
    SysDictDataResponse searchPage(SysDictDataParam sysDictDataParam);
     ...
     * @date 2021/5/21
     */
    List<SysDictData> findByParentIdIsNullList(String typeCode);
     ...
     *@创建时间  2021/5/21
     */
    SysDictDataResponse treeByCode(Long id);
     ...
     * @date 2020/3/31 21:07
     */
    List<SysDictData> childrenList(SysDictDataParam sysDictDataParam);
